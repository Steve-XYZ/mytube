...
const electronAPI = {
  ...
  retryDownload: (downloadId: string) => ipcRenderer.invoke(IPC_CHANNELS.DOWNLOAD_RETRY, downloadId),
  cancelDownload: (downloadId: string) => ipcRenderer.invoke(IPC_CHANNELS.DOWNLOAD_CANCEL, downloadId),
  pauseAllDownloads: () => ipcRenderer.invoke(IPC_CHANNELS.DOWNLOAD_PAUSE_ALL),
  resumeAllDownloads: () => ipcRenderer.invoke(IPC_CHANNELS.DOWNLOAD_RESUME_ALL),
  cancelPendingDownloads: () => ipcRenderer.invoke(IPC_CHANNELS.DOWNLOAD_CANCEL_PENDING),
  moveDownload: (downloadId: string, direction: 'up' | 'down' | 'top' | 'bottom') =>
    ipcRenderer.invoke(IPC_CHANNELS.DOWNLOAD_MOVE, downloadId, direction),
